...
{
    [Serializable]
    [MulticastAttributeUsage(MulticastTargets.Method, TargetMemberAttributes = MulticastAttributes.Instance)] //nesne örneklerinin metotlarına uygula constructorlarına uygulama
